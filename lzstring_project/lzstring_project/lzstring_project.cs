...
namespace lz_string_csharp
{
       public class LZString
    {
        ...
        private Context_Compress_Data writeBit(int value, Context_Compress_Data data)
        {
        ...
        private Context_Compress_Data writeBits(int numbits, int value, Context_Compress_Data data)
        {
        ...
        private Context_Compress produceW(Context_Compress context)
        {
        ...
        private Context_Compress decrementEnlargeIn(Context_Compress context)
        {
        ...
        private int readBit(Decompress_Data data)
        {
        ...
        private int readBits(int numBits, Decompress_Data data)
        {
