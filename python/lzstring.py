...
dataSrc = "C:\\inetpub\\wwwroot\\web\\compress\\lzstring_csharp\\data\\citytown.json"
compSrc = "C:\\inetpub\\wwwroot\\web\\compress\\lzstring_csharp\\data\\citytown_comp.json"
with open(dataSrc,"r", encoding="utf-8") as fin:
    compObj = LZString()
    #with open(compSrc,"w") as fout:
        #for line in fin:
            #compData = compObj.compressToBase64(line)
            #fout.write(compData)
